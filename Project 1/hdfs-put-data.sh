...
docker cp ../data/geolife_gps_trajectories.csv namenode:/data

docker exec -it namenode hdfs dfs -put ./data/geolife_gps_trajectories.csv ../../ #geolife_gps_sorted_without_nodata.csv
